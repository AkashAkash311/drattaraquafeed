...
export const PrevButton: React.FC<PropType> = ({ children, ...restProps }) => {
  return (
    <button
      type="button"
      className="appearance-none bg-transparent cursor-pointer flex items-center justify-center w-9 h-9 rounded-full shadow-inner text-gray-800 hover:text-black disabled:text-gray-400 disabled:cursor-not-allowed"
      {...restProps}
    >
      <svg
